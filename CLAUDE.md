...
- 数据:METR-LA (207 节点, speed)、PEMS-BAY (325)、PEMS04/08 (flow)。标准协议:
  12 步入 12 步出;METR/BAY 70/10/20 + masked MAE (0 为缺失);PEMS04/08 60/20/20。
- 实现:新建通用 loader (scripts/ 下),FDN 与 GWN 各 3 种子;5080 跑,每 run <1h。
