...
- incident-ft all candidates robust MAE: `0.7112`
- incident-ft affected candidates robust MAE: `1.1110`
- residual_beta: 1.05
...
|:--------|----------------------------------:|---------------------------------------:|-----------------------------------------:|
| val     |                            0.7171 |                                 1.1606 |                                   0.5323 |
| test    |                            0.7112 |                                 1.1110 |                                   0.5236 |

## Training

- best_epoch: 3
- best_val_loss: 0.6215
