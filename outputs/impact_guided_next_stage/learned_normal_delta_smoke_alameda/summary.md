...
测试集上，全候选邻域 robust MAE 从 `0.8370` 降到 `0.8368`，相对提升 `0.02%`。
...
|:--------|----------------------------------:|-------------------------------------:|---------------------------------:|---------------------------------------:|------------------------------------------:|--------------------------------------:|---------------------:|
| train   |                            0.8691 |                               0.8718 |                           0.3005 |                                 1.1471 |                                    1.1498 |                                0.2406 |               0.3354 |
| val     |                            0.9695 |                               0.9703 |                           0.0902 |                                 1.6071 |                                    1.6070 |                               -0.0057 |               0.2838 |
| test    |                            0.8368 |                               0.8370 |                           0.0176 |                                 1.2934 |                                    1.2929 |                               -0.0388 |               0.2447 |
...
|:---------|----------:|----------------------------------:|-------------------------------------:|---------------------------------:|---------------------------------------:|------------------------------------------:|--------------------------------------:|-----------------------------------------:|--------------------------------------------:|----------------------------------------:|---------------------:|
| Alameda  |       192 |                            0.8368 |                               0.8370 |                           0.0176 |                                 1.2934 |                                    1.2929 |                               -0.0388 |                                   0.6539 |                                      0.6544 |                                  0.0622 |               0.2447 |

## 训练情况

- 最佳轮数 best_epoch: 1
- 选择指标 best_metric: val_loss
- 最佳验证损失 best_val_loss: 0.6546
