...
- source all candidates robust MAE: `0.7112`
- source affected candidates robust MAE: `1.1110`
- incident-ft all candidates robust MAE: `0.7103`
- incident-ft affected candidates robust MAE: `1.1097`
- residual_beta: 1.00

## Settings

- model_dir: `outputs/impact_guided_next_stage/dual_branch_sttis_incident_ft_seed_7_final_only`
- train_gate: True
- epochs: 3
- lr: 0.0001
- affected_weight: 4.0
...
|:--------|----------------------------------:|---------------------------------------:|-----------------------------------------:|
| val     |                            0.7162 |                                 1.1591 |                                   0.5317 |
| test    |                            0.7103 |                                 1.1097 |                                   0.5229 |

## Training

- best_epoch: 3
- best_val_loss: 0.6257
