...
- adapter all candidates robust MAE: `0.706606`
- adapter affected candidates robust MAE: `1.101584`
- adapter unaffected candidates robust MAE: `0.521572`
...
|:--------|----------------------------------:|---------------------------------------:|-----------------------------------------:|
| val     |                          0.706398 |                               1.144799 |                                 0.527587 |
| test    |                          0.706606 |                               1.101584 |                                 0.521572 |

## Training

- best_epoch: 5
- best_selection_loss: 0.714416
- best_val_loss: 0.714416
