...
- adapter all candidates robust MAE: `0.706824`
- adapter affected candidates robust MAE: `1.101892`
- adapter unaffected candidates robust MAE: `0.521747`
...
- correction_l1_weight: 0.02
- unaffected_correction_weight: 0.05
- trainable parameters: 6797
...
|:--------|----------------------------------:|---------------------------------------:|-----------------------------------------:|
| val     |                          0.706686 |                               1.145241 |                                 0.527813 |
| test    |                          0.706824 |                               1.101892 |                                 0.521747 |

## Training

- best_epoch: 1
- best_val_loss: 0.747812
