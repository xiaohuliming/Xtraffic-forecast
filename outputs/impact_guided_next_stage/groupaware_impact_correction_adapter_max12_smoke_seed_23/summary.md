...
- adapter all candidates robust MAE: `0.706688`
- adapter affected candidates robust MAE: `1.101313`
- adapter unaffected candidates robust MAE: `0.521818`
...
|:--------|----------------------------------:|---------------------------------------:|-----------------------------------------:|
| val     |                          0.706220 |                               1.144015 |                                 0.527657 |
| test    |                          0.706688 |                               1.101313 |                                 0.521818 |

## Training

- best_epoch: 5
- best_selection_loss: 0.939812
- best_val_loss: 0.939812
