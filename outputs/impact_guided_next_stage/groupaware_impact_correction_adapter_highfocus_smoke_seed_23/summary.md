...
- adapter all candidates robust MAE: `0.706640`
- adapter affected candidates robust MAE: `1.101486`
- adapter unaffected candidates robust MAE: `0.521668`
...
|:--------|----------------------------------:|---------------------------------------:|-----------------------------------------:|
| val     |                          0.706450 |                               1.144720 |                                 0.527692 |
| test    |                          0.706640 |                               1.101486 |                                 0.521668 |

## Training

- best_epoch: 4
- best_selection_loss: 0.876835
- best_val_loss: 0.876835
