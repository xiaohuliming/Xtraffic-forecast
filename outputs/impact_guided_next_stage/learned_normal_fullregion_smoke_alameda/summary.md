...
测试集上，全候选邻域 robust MAE 从 `1.0434` 降到 `1.0438`，相对提升 `-0.05%`。

只看受影响候选节点，robust MAE 从 `1.3503` 降到 `1.3509`，相对提升 `-0.04%`。
...
|:--------|----------------------------------:|-------------------------------------:|---------------------------------:|---------------------------------------:|------------------------------------------:|--------------------------------------:|---------------------:|
| train   |                            0.6921 |                               0.6933 |                           0.1689 |                                 0.8398 |                                    0.8410 |                                0.1467 |               0.3040 |
| val     |                            0.8296 |                               0.8300 |                           0.0524 |                                 1.4837 |                                    1.4836 |                               -0.0053 |               0.2199 |
| test    |                            1.0438 |                               1.0434 |                          -0.0471 |                                 1.3509 |                                    1.3503 |                               -0.0437 |               0.3584 |
...
|:---------|----------:|----------------------------------:|-------------------------------------:|---------------------------------:|---------------------------------------:|------------------------------------------:|--------------------------------------:|-----------------------------------------:|--------------------------------------------:|----------------------------------------:|---------------------:|
| Alameda  |        32 |                            1.0438 |                               1.0434 |                          -0.0471 |                                 1.3509 |                                    1.3503 |                               -0.0437 |                                   0.8056 |                                      0.8051 |                                 -0.0514 |               0.3584 |

## 训练情况

- 最佳轮数 best_epoch: 1
- 选择指标 best_metric: val_loss
- 最佳验证损失 best_val_loss: 0.5301
