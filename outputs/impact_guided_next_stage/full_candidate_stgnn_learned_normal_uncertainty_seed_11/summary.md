...
测试集上，全候选邻域 robust MAE 从 `0.8328` 降到 `0.7268`，相对提升 `12.73%`。

只看受影响候选节点，robust MAE 从 `1.2938` 降到 `1.1408`，相对提升 `11.82%`。
...
|:--------|----------------------------------:|-------------------------------------:|---------------------------------:|---------------------------------------:|------------------------------------------:|--------------------------------------:|---------------------:|
| train   |                            0.6724 |                               0.7568 |                          11.1592 |                                 1.0285 |                                    1.1387 |                                9.6728 |               0.2275 |
| val     |                            0.7314 |                               0.8273 |                          11.5876 |                                 1.1875 |                                    1.3241 |                               10.3152 |               0.2343 |
| test    |                            0.7268 |                               0.8328 |                          12.7280 |                                 1.1408 |                                    1.2938 |                               11.8250 |               0.2498 |
...
|:------------|----------:|----------------------------------:|-------------------------------------:|---------------------------------:|---------------------------------------:|------------------------------------------:|--------------------------------------:|-----------------------------------------:|--------------------------------------------:|----------------------------------------:|---------------------:|
| Alameda     |      9256 |                            0.7246 |                               0.8466 |                          14.4077 |                                 1.1751 |                                    1.3749 |                               14.5360 |                                   0.5190 |                                      0.6054 |                                 14.2748 |               0.2498 |
| ContraCosta |      4002 |                            0.7210 |                               0.8162 |                          11.6681 |                                 1.1049 |                                    1.2469 |                               11.3862 |                                   0.5425 |                                      0.6160 |                                 11.9333 |               0.2491 |
| Orange      |     14241 |                            0.7300 |                               0.8305 |                          12.1043 |                                 1.1336 |                                    1.2647 |                               10.3601 |                                   0.5370 |                                      0.6230 |                                 13.7965 |               0.2501 |

## 训练情况

- 最佳轮数 best_epoch: 5
- 选择指标 best_metric: val_loss
- 最佳验证损失 best_val_loss: 0.4429
