...
测试集上，全候选邻域 robust MAE 从 `0.8370` 降到 `0.8366`，相对提升 `0.04%`。

只看受影响候选节点，robust MAE 从 `1.2929` 降到 `1.2933`，相对提升 `-0.03%`。
...
|:--------|----------------------------------:|-------------------------------------:|---------------------------------:|---------------------------------------:|------------------------------------------:|--------------------------------------:|---------------------:|
| train   |                            0.8687 |                               0.8718 |                           0.3507 |                                 1.1462 |                                    1.1498 |                                0.3154 |               0.3354 |
| val     |                            0.9694 |                               0.9703 |                           0.0920 |                                 1.6065 |                                    1.6070 |                                0.0305 |               0.2838 |
| test    |                            0.8366 |                               0.8370 |                           0.0422 |                                 1.2933 |                                    1.2929 |                               -0.0295 |               0.2447 |
...
|:---------|----------:|----------------------------------:|-------------------------------------:|---------------------------------:|---------------------------------------:|------------------------------------------:|--------------------------------------:|-----------------------------------------:|--------------------------------------------:|----------------------------------------:|---------------------:|
| Alameda  |       192 |                            0.8366 |                               0.8370 |                           0.0422 |                                 1.2933 |                                    1.2929 |                               -0.0295 |                                   0.6537 |                                      0.6544 |                                  0.0990 |               0.2447 |

## 训练情况

- 最佳轮数 best_epoch: 1
- 选择指标 best_metric: val_loss
- 最佳验证损失 best_val_loss: 0.6569
