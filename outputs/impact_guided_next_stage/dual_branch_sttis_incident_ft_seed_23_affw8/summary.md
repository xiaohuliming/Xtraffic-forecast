...
- incident-ft all candidates robust MAE: `0.7104`
- incident-ft affected candidates robust MAE: `1.1061`
- residual_beta: 1.10
...
|:--------|----------------------------------:|---------------------------------------:|-----------------------------------------:|
| val     |                            0.7175 |                                 1.1597 |                                   0.5333 |
| test    |                            0.7104 |                                 1.1061 |                                   0.5248 |

## Training

- best_epoch: 3
- best_val_loss: 1.0563
