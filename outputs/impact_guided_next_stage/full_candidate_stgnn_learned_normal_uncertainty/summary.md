...
测试集上，全候选邻域 robust MAE 从 `0.8328` 降到 `0.7248`，相对提升 `12.97%`。

只看受影响候选节点，robust MAE 从 `1.2938` 降到 `1.1381`，相对提升 `12.04%`。
...
|:--------|----------------------------------:|-------------------------------------:|---------------------------------:|---------------------------------------:|------------------------------------------:|--------------------------------------:|---------------------:|
| train   |                            0.6705 |                               0.7568 |                          11.3994 |                                 1.0269 |                                    1.1387 |                                9.8200 |               0.2275 |
| val     |                            0.7298 |                               0.8273 |                          11.7820 |                                 1.1859 |                                    1.3241 |                               10.4372 |               0.2343 |
| test    |                            0.7248 |                               0.8328 |                          12.9725 |                                 1.1381 |                                    1.2938 |                               12.0370 |               0.2498 |
...
|:------------|----------:|----------------------------------:|-------------------------------------:|---------------------------------:|---------------------------------------:|------------------------------------------:|--------------------------------------:|-----------------------------------------:|--------------------------------------------:|----------------------------------------:|---------------------:|
| Alameda     |      9256 |                            0.7215 |                               0.8466 |                          14.7723 |                                 1.1674 |                                    1.3749 |                               15.0947 |                                   0.5180 |                                      0.6054 |                                 14.4382 |               0.2498 |
| ContraCosta |      4002 |                            0.7184 |                               0.8162 |                          11.9787 |                                 1.1016 |                                    1.2469 |                               11.6490 |                                   0.5403 |                                      0.6160 |                                 12.2889 |               0.2491 |
| Orange      |     14241 |                            0.7287 |                               0.8305 |                          12.2592 |                                 1.1338 |                                    1.2647 |                               10.3514 |                                   0.5351 |                                      0.6230 |                                 14.1101 |               0.2501 |

## 训练情况

- 最佳轮数 best_epoch: 5
- 选择指标 best_metric: val_loss
- 最佳验证损失 best_val_loss: 0.4414
