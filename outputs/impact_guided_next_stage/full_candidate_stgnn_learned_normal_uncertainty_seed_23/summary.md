...
测试集上，全候选邻域 robust MAE 从 `0.8328` 降到 `0.7250`，相对提升 `12.94%`。

只看受影响候选节点，robust MAE 从 `1.2938` 降到 `1.1382`，相对提升 `12.03%`。
...
|:--------|----------------------------------:|-------------------------------------:|---------------------------------:|---------------------------------------:|------------------------------------------:|--------------------------------------:|---------------------:|
| train   |                            0.6708 |                               0.7568 |                          11.3605 |                                 1.0270 |                                    1.1387 |                                9.8068 |               0.2275 |
| val     |                            0.7297 |                               0.8273 |                          11.7874 |                                 1.1857 |                                    1.3241 |                               10.4537 |               0.2343 |
| test    |                            0.7250 |                               0.8328 |                          12.9442 |                                 1.1382 |                                    1.2938 |                               12.0259 |               0.2498 |
...
|:------------|----------:|----------------------------------:|-------------------------------------:|---------------------------------:|---------------------------------------:|------------------------------------------:|--------------------------------------:|-----------------------------------------:|--------------------------------------------:|----------------------------------------:|---------------------:|
| Alameda     |      9256 |                            0.7221 |                               0.8466 |                          14.7004 |                                 1.1697 |                                    1.3749 |                               14.9292 |                                   0.5179 |                                      0.6054 |                                 14.4634 |               0.2498 |
| ContraCosta |      4002 |                            0.7192 |                               0.8162 |                          11.8888 |                                 1.1017 |                                    1.2469 |                               11.6461 |                                   0.5414 |                                      0.6160 |                                 12.1172 |               0.2491 |
| Orange      |     14241 |                            0.7285 |                               0.8305 |                          12.2754 |                                 1.1328 |                                    1.2647 |                               10.4288 |                                   0.5353 |                                      0.6230 |                                 14.0667 |               0.2501 |

## 训练情况

- 最佳轮数 best_epoch: 5
- 选择指标 best_metric: val_loss
- 最佳验证损失 best_val_loss: 0.4413
