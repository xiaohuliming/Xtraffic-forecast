...
- source all candidates robust MAE: `0.7088`
- source affected candidates robust MAE: `1.1082`
- incident-ft all candidates robust MAE: `0.7086`
- incident-ft affected candidates robust MAE: `1.1066`
- residual_beta: 1.00

## Settings

- model_dir: `outputs/impact_guided_next_stage/dual_branch_sttis_incident_ft_seed_11_final_only`
- train_gate: True
- epochs: 3
- lr: 0.0001
- affected_weight: 4.0
...
|:--------|----------------------------------:|---------------------------------------:|-----------------------------------------:|
| val     |                            0.7147 |                                 1.1573 |                                   0.5303 |
| test    |                            0.7086 |                                 1.1066 |                                   0.5218 |

## Training

- best_epoch: 1
- best_val_loss: 0.6245
