...
- incident-ft all candidates robust MAE: `0.7180`
- incident-ft affected candidates robust MAE: `1.0905`
- residual_beta: 1.05
...
|:--------|----------------------------------:|---------------------------------------:|-----------------------------------------:|
| train   |                            0.6570 |                                 0.9933 |                                   0.5129 |
| val     |                            0.7126 |                                 1.1478 |                                   0.5347 |
| test    |                            0.7180 |                                 1.0905 |                                   0.5322 |

## Training

- best_epoch: 1
- best_val_loss: 0.9738
