...
- source all candidates robust MAE: `0.710033`
- source affected candidates robust MAE: `1.107757`
- adapter all candidates robust MAE: `0.713955`
- adapter affected candidates robust MAE: `1.103285`
- adapter unaffected candidates robust MAE: `0.528413`

## Settings

- model_dir: `outputs/impact_guided_next_stage/dual_branch_sttis_incident_ft_seed_7_normal_veto_hierarchical_pretrain_afffocus3_groupaware`
- base_beta: 1.1
- epochs: 5
- lr: 0.001
- max_correction: 0.8
...
|:--------|----------------------------------:|---------------------------------------:|-----------------------------------------:|
| val     |                          0.717366 |                               1.166280 |                                 0.530424 |
| test    |                          0.713955 |                               1.103285 |                                 0.528413 |

## Training

- best_epoch: 5
- best_selection_loss: 0.723643
- best_val_loss: 0.909688
